...
import main.java.COMP380.LAGA.Hotel_API.controller.EmployeeRepository;
...
public class HotelController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteHotel(@PathVariable Long id, @PathVariable Integer employeeId) {
